...
class EDO_Solver:
    def __init__(self, master=None):
        ...
        self.output.configure(highlightbackground="white")
        ...
        canvas.get_tk_widget().pack(side = TOP,fill = BOTH,expand = 0.1)
        plotToolbar = NavigationToolbar2TkAgg(canvas,self.output)
