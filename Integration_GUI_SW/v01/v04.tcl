...
proc vTclWindow.top36 {base} {
    ...
    radiobutton $top.rad48 \
        ...
        -background {#d9d9d9} -borderwidth 3 -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -offrelief ridge \
        -overrelief ridge -padx 2 -pady 2 -relief ridge -state active \
        -text Relatório -variable output_selection 
    vTcl:DefineAlias "$top.rad48" "Relat" vTcl:WidgetProc "EDO_main_window" 1
    radiobutton $top.rad49 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -borderwidth 3 -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -offrelief ridge \
        -padx 2 -pady 2 -relief ridge -state active -text Gráfico \
        -variable output_selection 
    ...
    place $top.can47 \
        ...
        -bordermode ignore 
    place $top.rad48 \
        -in $top -x 40 -y 160 -width 95 -height 24 -anchor nw \
        -bordermode ignore 
    place $top.rad49 \
        -in $top -x 130 -y 160 -width 94 -height 24 -anchor nw \
        -bordermode ignore 
