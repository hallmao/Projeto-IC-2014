...
def init(a2, a1, a0, xT):
        ...
        eq = sympify(
                 a5 * y(t).diff(t, 5) + a4 * y(t).diff(t, 4) + a3 * y(t).diff(t, 3) + a2 * y(t).diff(t, 2) + a1 * y(t).diff(
                                t) + a0 * y(t) - xT)
        print type(a2), type(a1), type(a0), type(Respostas[7]), a2, a1, a0, Respostas[7]
        print type(eq), eq
        
        edo_main(a2,a1,a0, eq)
...
def print_latex():
        ...
        plt.text(xdif,0.9-7*dif,'x(t) = '+ur''+xTLatex)
...
def edo_main(a2,a1,a0, eq):
        ...
        try:               
                ...
                raizes()
                conds_iniciais_aplicadas(fN, rP, a5, a4, a3, a2, a1, a0, xT)
                ...
                print "did it o/", Respostas[0],Respostas[1],Respostas[2],Respostas[3]
                print Respostas[4],Respostas[5],Respostas[6]
        except:
                print "erro"
                pass
