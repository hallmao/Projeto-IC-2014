...
foreach img {
        ...
        {{$[pwd]/images/Newton_order5.gif} {user image} user {}}
...
proc vTclWindow.top36 {base} {
    ...
    label $top.lab37 \
        ...
        -image [vTcl:image:get_image [file join / Users Michael Desktop {Projeto IC 2014} Integration_GUI_SW v04 images Newton_order5.gif]] \
        -relief ridge -text {Diff Equation Here} -width 800 
    vTcl:DefineAlias "$top.lab37" "EDO_viewer" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab37.ent38 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab37.ent38" "Entry3" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab37.ent39 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab37.ent39" "Entry4" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab37.ent40 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab37.ent40" "Entry5" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab37.ent41 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab37.ent41" "Entry6" vTcl:WidgetProc "EDO_main_window" 1
    label $top.lab40 \
    ...
    entry $top.lab40.ent43 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab40.ent43" "Entry8" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab40.ent44 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab40.ent44" "Entry9" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab40.ent45 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab40.ent45" "Entry10" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab40.ent46 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab40.ent46" "Entry11" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.lab40.ent47 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.lab40.ent47" "Entry12" vTcl:WidgetProc "EDO_main_window" 1
    label $top.lab41 \
    ...
    ttk::entry $top.lab41.tEn48 \
        -foreground {} -background {} -takefocus {} -cursor ibeam 
    vTcl:DefineAlias "$top.lab41.tEn48" "TEntry1" vTcl:WidgetProc "EDO_main_window" 1
    menu $top.m50 \
    ...
    entry $top.ent36 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.ent36" "Entry1" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.cpd37 \
        -background white -font TkFixedFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -takefocus 0 
    vTcl:DefineAlias "$top.cpd37" "Entry2" vTcl:WidgetProc "EDO_main_window" 1
    entry $top.ent42 \
        -background white -font TkFixedFont -foreground {#000000} \
        -insertbackground black -takefocus 0 
    vTcl:DefineAlias "$top.ent42" "Entry7" vTcl:WidgetProc "EDO_main_window" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab37 \
        ...
        -bordermode ignore 
    place $top.lab37.ent38 \
        -in $top.lab37 -x 260 -y 60 -width 42 -height 37 -anchor nw \
        -bordermode ignore 
    place $top.lab37.ent39 \
        -in $top.lab37 -x 370 -y 60 -width 42 -height 37 -anchor nw \
        -bordermode ignore 
    place $top.lab37.ent40 \
        -in $top.lab37 -x 480 -y 60 -width 42 -height 37 -anchor nw \
        -bordermode ignore 
    place $top.lab37.ent41 \
        -in $top.lab37 -x 590 -y 60 -width 32 -height 37 -anchor nw \
        -bordermode ignore 
    place $top.lab40 \
        -in $top -x 0 -y 100 -width 310 -height 82 -anchor nw \
        -bordermode ignore 
    place $top.lab40.ent43 \
        -in $top.lab40 -x 180 -y 10 -width 22 -height 27 -anchor nw \
        -bordermode ignore 
    place $top.lab40.ent44 \
        -in $top.lab40 -x 260 -y 10 -width 22 -height 27 -anchor nw \
        -bordermode ignore 
    place $top.lab40.ent45 \
        -in $top.lab40 -x 260 -y 50 -width 22 -height 27 -anchor nw \
        -bordermode ignore 
    place $top.lab40.ent46 \
        -in $top.lab40 -x 170 -y 50 -width 22 -height 27 -anchor nw \
        -bordermode ignore 
    place $top.lab40.ent47 \
        -in $top.lab40 -x 60 -y 50 -width 22 -height 27 -anchor nw \
        -bordermode ignore 
    place $top.lab41 \
        -in $top -x 310 -y 100 -width 490 -height 82 -anchor nw \
        -bordermode ignore 
    place $top.lab41.tEn48 \
        -in $top.lab41 -x 100 -y 20 -width 380 -height 46 -anchor nw \
        -bordermode ignore 
    place $top.fra37 \
        -in $top -x 0 -y 560 -width 805 -height 65 -anchor nw \
        -bordermode ignore 
    place $top.tNo36 \
        -in $top -x 0 -y 220 -width 804 -height 370 -anchor nw \
        -bordermode ignore 
    place $top.ent36 \
        -in $top -x 20 -y 60 -width 42 -height 37 -anchor nw \
        -bordermode ignore 
    place $top.cpd37 \
        -in $top -x 140 -y 60 -width 42 -height 37 -anchor nw \
        -bordermode inside 
    place $top.ent42 \
        -in $top -x 100 -y -10 -anchor nw -bordermode ignore 
