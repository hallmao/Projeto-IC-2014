...
proc vTcl:project:info {} {
    ...
    set site_4_0 .top36.tNo63.pg0 
    set site_4_1 .top36.tNo63.pg1 
...
proc vTclWindow.top36 {base} {
    ...
    vTcl:toplevel $top -class Toplevel \
        -menu "$top.m41" -background {#747e7f} -highlightbackground {#d9d9d9} \
    ...
    $site_3_0.men42 add radiobutton \
        ...
        -background {#d9d9d9} -command TODO -font TkMenuFont \
        -foreground {#000000} -label Espanol 
    $site_3_0.men42 add radiobutton \
        -value PT -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command TODO -font TkMenuFont \
        -foreground {#000000} -label Portugues 
    $top.m41 add cascade \
    ...
    ttk::notebook $top.tNo63 \
        -width 804 -height 470 -takefocus {} 
    vTcl:DefineAlias "$top.tNo63" "Abas" vTcl:WidgetProc "EDO_mainWindow" 1
    frame .top36.tNo63.pg0 -background #d9d9d9
    $top.tNo63 add .top36.tNo63.pg0 \
        -padding 0 -sticky nsew -state normal -text Relatorio -image {} \
        -compound none -underline -1 
    set site_4_0  $top.tNo63.pg0
    frame .top36.tNo63.pg1 -background #d9d9d9
    $top.tNo63 add .top36.tNo63.pg1 \
        -padding 0 -sticky nsew -state normal -text Graficos -image image145 \
        -compound none -underline -1 
    set site_4_1  $top.tNo63.pg1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tLa53 \
    ...
    place $top.tLa61 \
        ...
        -bordermode ignore 
    place $top.tNo63 \
        -in $top -x 0 -y 130 -width 804 -height 470 -anchor nw \
        -bordermode ignore 
