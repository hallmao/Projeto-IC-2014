...
proc vTclWindow.top36 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 800x600+1808+352; update
    ...
    $site_3_0.men42 add radiobutton \
        -value EN -variable selectedButton -activebackground {#d9d9d9} \
        -activeforeground {#000000} -background {#d9d9d9} -command TODO \
        -font TkMenuFont -foreground {#000000} -label English 
    $site_3_0.men42 add radiobutton \
        -value ES -variable selectedButton -activebackground {#d9d9d9} \
        -activeforeground {#000000} -background {#d9d9d9} -command TODO \
        -font TkMenuFont -foreground {#000000} -label Español 
    $site_3_0.men42 add radiobutton \
        -value PT -variable selectedButton -activebackground {#d9d9d9} \
        -activeforeground {#000000} -background {#d9d9d9} -command TODO \
    ...
    $site_3_0.men43 add radiobutton \
        -variable selectedButton -activebackground {#d9d9d9} \
        -activeforeground {#000000} -background {#d9d9d9} -command TODO \
        -font TkMenuFont -foreground {#000000} -label Fisica 
    $top.m41 add cascade \
