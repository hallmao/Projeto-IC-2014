...
proc vTclWindow.top36 {base} {
    ...
    vTcl:DefineAlias "$top.tLa53.tEn54" "TEntry1" vTcl:WidgetProc "EDO_mainWindow" 1
    ttk::entry $top.tLa53.tEn55 \
        -foreground {} -background {} -takefocus {} -cursor ibeam 
    vTcl:DefineAlias "$top.tLa53.tEn55" "TEntry2" vTcl:WidgetProc "EDO_mainWindow" 1
    ttk::entry $top.tLa53.tEn56 \
        -foreground {} -background {} -takefocus {} -cursor ibeam 
    vTcl:DefineAlias "$top.tLa53.tEn56" "TEntry3" vTcl:WidgetProc "EDO_mainWindow" 1
    ttk::entry $top.tEn57 \
        -foreground {} -background {} -takefocus {} -cursor ibeam 
