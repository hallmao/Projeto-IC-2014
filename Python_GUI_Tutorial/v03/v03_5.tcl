...
proc vTclWindow.top36 {base} {
    ...
    ttk::entry $top.tLa53.tEn54 \
        ...
        -cursor ibeam 
    vTcl:DefineAlias "$top.tLa53.tEn54" "a1_" vTcl:WidgetProc "EDO_mainWindow" 1
    ...
    ttk::labelframe $top.tLa58 \
        -text {Condições Iniciais : y'(0) =               y(0) =} -width 450 \
        -height 35 -takefocus 0 
    vTcl:DefineAlias "$top.tLa58" "TLabelframe1" vTcl:WidgetProc "EDO_mainWindow" 1
    set site_3_0 $top.tLa58
    ttk::entry $site_3_0.tEn59 \
        -foreground {} -background {} -takefocus {} -cursor ibeam 
    vTcl:DefineAlias "$site_3_0.tEn59" "TEntry5" vTcl:WidgetProc "EDO_mainWindow" 1
    ...
    place $top.tLa58 \
        -in $top -x 0 -y 90 -width 450 -height 35 -anchor nw \
        -bordermode ignore 
