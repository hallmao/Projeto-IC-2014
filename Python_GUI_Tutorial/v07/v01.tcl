...
proc vTclWindow.top36 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 800x600+67+74; update
    wm maxsize $top 1280 752
    wm minsize $top 72 1
    wm overrideredirect $top 0
    ...
    vTcl:DefineAlias "$top.fra36" "output" vTcl:WidgetProc "EDO_main_window" 1
    frame $top.fra37 \
        -borderwidth 3 -relief ridge -background white -height 75 -width 805 
    ...
    place $top.rad49 \
        ...
        -bordermode ignore 
    place $top.fra36 \
        -in $top -x 0 -y 180 -width 805 -height 375 -anchor nw \
        -bordermode ignore 
    place $top.fra37 \
        -in $top -x 0 -y 550 -width 805 -height 75 -anchor nw \
        -bordermode ignore 
