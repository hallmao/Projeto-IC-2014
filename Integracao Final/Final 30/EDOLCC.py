...
##            flag_graf = True
    ...
    def set_notation(self):
        ...
        if(notation.get()==1):
            ...
            self.in_a0.place(relx=0.785)    
            self.in_a1.place(relx=0.647)
            self.in_a2.place(relx=0.487)
            self.in_a3.place(relx=0.331)
            self.in_a4.place(relx=0.172)
            self.in_a5.place(relx=0.01)

        elif(notation.get()==2):
            self.eq_label.configure(image=self._img2)
            self.in_a0.place(relx=0.809,relwidth=0.025)
            self.in_a1.place(relx=0.661,relwidth=0.025)
            self.in_a2.place(relx=0.506,relwidth=0.025)
            self.in_a3.place(relx=0.342,relwidth=0.025)
            self.in_a4.place(relx=0.183,relwidth=0.025)
            self.in_a5.place(relx=0.01,relwidth=0.025)
        elif(notation.get()==3):
            self.eq_label.configure(image=self._img3)
            self.in_a0.place(relx=0.797,relwidth=0.025)
            self.in_a1.place(relx=0.651,relwidth=0.025)
            self.in_a2.place(relx=0.500,relwidth=0.025)
            self.in_a3.place(relx=0.334,relwidth=0.025)
            self.in_a4.place(relx=0.185,relwidth=0.025)
            self.in_a5.place(relx=0.02,relwidth=0.025)
        elif (notation.get() == 4 ):
            self.eq_label.configure(image=self._img4)
            self.in_a0.place(relx=0.785)       
            self.in_a1.place(relx=0.647)
            self.in_a2.place(relx=0.491)
            self.in_a3.place(relx=0.331)
            self.in_a4.place(relx=0.178)
            self.in_a5.place(relx=0.01)
    ...
    def __init__(self, master):
        ...
        self.in_a5.place(relx=0.01,rely=0.03,relheight=0.04,relwidth=0.03)
        ...
        self.in_a4.place(relx=0.172,rely=0.03,relheight=0.04,relwidth=0.03)
        ...
        self.in_a3.place(relx=0.331,rely=0.03,relheight=0.04,relwidth=0.03)
        ...
        self.in_a2.place(relx=0.487,rely=0.03,relheight=0.04,relwidth=0.03)
        ...
        self.in_a1.place(relx=0.647,rely=0.03,relheight=0.04,relwidth=0.03)
        ...
        self.in_a0.place(relx=0.785,rely=0.03,relheight=0.04,relwidth=0.03)
