...
##            flag_graf = True
    ...
    def set_notation(self):
        ...
        if(notation.get()==1):
            ...
            self.in_a0.place_configure(relx=0.79)
            self.in_a1.place_configure(relx=0.649)
            self.in_a2.place_configure(relx=0.489)
            self.in_a3.place_configure(relx=0.333)
            self.in_a4.place_configure(relx=0.174)
            self.in_a5.place_configure(relx=0.012)

        elif(notation.get()==2):
            self.eq_label.configure(image=self._img2)
            self.in_a0.place_configure(relx=0.809)
            self.in_a1.place_configure(relx=0.661)
            self.in_a2.place_configure(relx=0.506)
            self.in_a3.place_configure(relx=0.342)
            self.in_a4.place_configure(relx=0.183)
            self.in_a5.place_configure(relx=0.01)
        elif(notation.get()==3):
            self.eq_label.configure(image=self._img3)
            self.in_a0.place_configure(relx=0.797)
            self.in_a1.place_configure(relx=0.651)
            self.in_a2.place_configure(relx=0.500)
            self.in_a3.place_configure(relx=0.334)
            self.in_a4.place_configure(relx=0.1855)
            self.in_a5.place_configure(relx=0.02)
        elif (notation.get() == 4 ):
            self.eq_label.configure(image=self._img4)
            self.in_a0.place_configure(relx=0.792)
            self.in_a1.place_configure(relx=0.647)
            self.in_a2.place_configure(relx=0.491)
            self.in_a3.place_configure(relx=0.331)
            self.in_a4.place_configure(relx=0.178)
            self.in_a5.place_configure(relx=0.01)
    ...
    def __init__(self, master):
        ...
        self.in_a5.place(relx=0.012,rely=0.03,relheight=0.04,relwidth=0.025)
        ...
        self.in_a4.place(relx=0.174,rely=0.03,relheight=0.04,relwidth=0.025)
        ...
        self.in_a3.place(relx=0.333,rely=0.03,relheight=0.04,relwidth=0.025)
        ...
        self.in_a2.place(relx=0.489,rely=0.03,relheight=0.04,relwidth=0.025)
        ...
        self.in_a1.place(relx=0.649,rely=0.03,relheight=0.04,relwidth=0.025)
        ...
        self.in_a0.place(relx=0.79,rely=0.03,relheight=0.04,relwidth=0.025)
