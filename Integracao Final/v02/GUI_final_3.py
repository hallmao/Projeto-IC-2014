...
class EDO_Solver:
    ...
    def update_saida(self):
        ...
        # canvas_latex.get_tk_widget().pack_forget()
        # canvas_plots.get_tk_widget().pack_forget()
        # canvas_latex.get_renderer(cleared=True)
        # canvas_plots.get_renderer(cleared=True)

        canvas_plots.get_tk_widget().destroy()
        canvas_latex.get_tk_widget().destroy()

        #self.frame_plot.update()
        #self.frame_latex.update()
...
####Handlers
    ...
    def set_bind_entries(self):
        ...
        self.in_y0.bind("<FocusOut>",self.y0_handler)
        self.in_dy0.bind("<FocusOut>",self.dy0_handler)
