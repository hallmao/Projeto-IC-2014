...
####Handlers-------------------------------------------
 ...
 #user input -># ao,a1,a2,y0,dy0,xT
    ...
    def slider(self):
        ...
        self.ScaleMin = Scale(self.mast)
        self.ScaleMin.place(relx=0.01,rely=0.948,relwidth=0.1,relheight=0.0
                ,height=47, width=100)
        ...
        self.ScaleMax = Scale(self.mast)
        self.ScaleMax.place(relx=0.79,rely=0.948,relwidth=0.1,relheight=0.0
                ,height=47, width=100)
    ...
    def abaPlots_handler(self,event):
        ...
        if(flag_graf==False):
            ...
            toolbar.pack(side = TOP, fill = Y)
            self.label_menu_plot.configure(anchor=NW, text = "\n\t\t\t\t           Limite Minimo \t\t\t\t\t\t\t\t\t Limite Maximo")
            self.slider()
            flag_rep = False
            flag_graf = True
