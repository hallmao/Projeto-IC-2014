...
from sympy import Function, exp, cos,  sympify, dsolve, symbols,mpmath, solve, lambdify, sin, im, \
        re, latex,simplify, nsimplify,collect
...
def idioma_log_print():
    ...
    if(lingua==1):
        ...
        return idi_eq, idi_raiz_pl, idi_raiz_sing, idi_yfn, idi_yn, idi_yp, idi_ytrans, idi_yf, idi_yc, idi_cond_sing, idi_cond_pl
...
def log_print():
        ...
        idi_eq, idi_raiz_pl, idi_raiz_sing, idi_yfn, idi_yn, idi_yp, idi_ytrans, idi_yf, idi_yc, idi_cond_sing, idi_cond_pl = idioma_log_print()
...
def idioma_print_latex():
    ...
    if(lingua==1):
        ...
        idi_cond_sing = "Condicao inicial: "
        idi_cond_pl = "Condicoes iniciais: "
        return idi_raiz, idi_eq, idi_yfn, idi_yn, idi_yp, idi_yt, idi_yf, idi_yc, idi_cond_sing, idi_cond_pl
...
def print_latex():
        ...
        idi_raiz, idi_eq, idi_yfn, idi_yn, idi_yp, idi_yt, idi_yf, idi_yc, idi_cond_sing, idi_cond_pl = idioma_print_latex()
        #plt.clf()
        #edo_main()
        #for i in range(1,7):Respostas[i] = nsimplify(Respostas[i], rational = False).evalf(prec)
        ...
        for i in range(len(Respostas)):
                RespostasEmLatex[i] = '$'+str(latex(Respostas[i], long_frac_ratio = 0, fold_func_brackets = True)) +'$'
