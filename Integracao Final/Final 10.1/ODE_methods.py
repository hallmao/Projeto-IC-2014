...
def print_latex():
        ...
        for i in range(1,7):
                try:
                        ...
                        print "Deu problema no indice : ",i
        ...
        plt.text(xdif,0.9-dif,str_r+ur''+
                 str_raizLatex+'   '+str_t+
                 ur''+str_talLatex)
        
        plt.text(xdif,0.9-2*dif,ur''+
                 idi_yfn+ur'$'+latex("(")+'$'+
                 ur''+RespostasEmLatex[1]+
                 ur'$'+latex(")u(t)")+'$')
        
        if((const[5] == 0) and (const[4] == 0) and (const[3] == 0) and (const[2] == 0)):#eq ordem 1
            plt.text(xdif,0.9-3*dif,ur''+idi_yn+
                     ur'$'+latex("(")+'$'+
                     ur''+RespostasEmLatex[2]+
                     ur'$'+latex(")u(t)")+idi_cond_sing+latex("y(0)= ")+latex(cond_ini[0]) +'$')
        else:
            plt.text(xdif,0.9-3*dif,ur''+idi_yn+
                     ur'$'+latex("(")+'$'+ur''+RespostasEmLatex[2]+
                     ur'$'+latex(")u(t)")+latex(idi_cond_pl)+ latex("y(0)=")+latex(str(cond_ini[0]))+'$'+
                     ur'$'+latex("\ \ \dot y(0)= ")+latex(cond_ini[1]) + '$')

            
        plt.text(xdif,0.9-4*dif,ur''+idi_yp+
                 ur'$'+latex("(")+'$'+
        ...
        plt.text(xdif,0.9-5*dif,ur''+idi_yt+
                 ur'$'+latex("(")+'$'+
                 ur''+RespostasEmLatex[4]+
                 ur'$'+latex(")u(t)")+'$')
        
        plt.text(xdif,0.9-6*dif,ur''+idi_yf+
                 ur'$'+latex("(")+'$'+
                 ur''+RespostasEmLatex[5]+
                 ur'$'+latex(")u(t)")+'$')
        
        plt.text(xdif,0.9-7*dif,ur''+idi_yc+
                 ur'$'+latex("(")+'$'+
