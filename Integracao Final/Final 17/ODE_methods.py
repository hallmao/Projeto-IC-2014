...
def show_plots():
       ...
       # ax.set_ylim(-abs(abs(float(plotRaizesC[0])) +1),abs(abs(float(plotRaizesC[len(plotRaizesC)-1]))+ 1)  )
        ...
        ax.set_ylim(float(-abs(plotRaizesC[-1] + 0.2*plotRaizesC[-1])),float(abs(plotRaizesC[-1]+ 0.2*plotRaizesC[-1]) ))
        ax.set_xlim(float(-abs(plotRaizesR[-1]+ 0.2*plotRaizesR[-1])),float(abs(plotRaizesR[-1]+ 0.2*plotRaizesR[-1]) ) )
