...
####Handlers-------------------------------------------
  #user input -># ao,a1,a2,y0,dy0,xT
    def a0_handler(self,event):
        ...
        self.in_a0.configure(validate = 'focusin',validatecommand = (okay_entry_a0,'%s','a0'))
        a0 = self.in_a0.get()
    ...
    def a1_handler(self,event):
        ...
        self.in_a1.configure(validate = 'focusin',validatecommand = (okay_entry_a1,'%s','a1'))
        a1 = self.in_a1.get()
        print "User input",user_input
        print "In a1 now",a1
        self.can_update()
    ...
    def a2_handler(self,event):
        ...
        self.in_a2.configure(validate = 'focusin',validatecommand = (okay_entry_a2,'%s','a2'))
        a2 = self.in_a2.get()
        print "User input",user_input
        print "In a2 now",a2
        self.can_update()
    ...
    def inxT_handler(self,event):
        ...
        self.in_xT.configure(validate = 'focusin',validatecommand = (okay_entry_xT,'%s','xT'))
        xT = self.in_xT.get()
        print "User input",user_input
        print "In xT now",xT
        self.can_update()
 ...
 #user input -># ao,a1,a2,y0,dy0,xT
    def y0_handler(self,event):
        ...
        self.in_y0.configure(validate = 'focusin',validatecommand = (okay_entry_y0,'%s','y0'))
        y0 = self.in_y0.get()
        print "User input",user_input
        print "In y0 now",y0
        self.can_update()
    ...
    def dy0_handler(self,event):
      #print "apertei",self.in_a2.get()
        ...
        self.in_dy0.configure(validate = 'focusin',validatecommand = (okay_entry_dy0,'%s','dy0'))
        dy0 = self.in_dy0.get()
        print "User input",user_input
