...
while True:
	...
	def conds_iniciais_aplicadas():
		...
		formaNat  = sympify(formaNatural, rational = False,evaluate= False).evalf(prec)
		print"yLinhaNat:", ylinhaNat
		## Agora é necessário resolver o sistema:
		#  ynat(t) = y(0)
		#  ynat'(0)= y'(0)
		valorConstantes = solve([formaNat -y0,ylinhaNat -dy0],implicit=True)

		print "Valor das constantes",valorConstantes
