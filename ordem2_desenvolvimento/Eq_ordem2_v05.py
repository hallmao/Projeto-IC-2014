...
yForcadaXs = ( xS/(a2*(s**2) +a1*s+a0) )


#print"YF fraction:", YFF


print "YforcadaXs: ",yForcadaXs,decompose(yForcadaXs)



yForcadaXt = inverse_laplace_transform(yForcadaXs,s,t)

print "Resposta Forcada:" ,yForcadaXt.evalf(2)
...
print "Resposta Natural: ",yNaturalXt.evalf(2)
